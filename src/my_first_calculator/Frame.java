  ...
  private JButton Clear=new JButton("C");
    public void intitialize(){
        ...
        for(int i = 0;i<butt.length;i++){
            ...
            butt[i].setFont(f);
            butt[i].addActionListener(new eventhandle());
            this.add(butt[i]);
        }
        ...
        Clear.setFont(f);
        this.add(Clear);
        Clear.addActionListener(new eventhandle());
        plus.addActionListener(new eventhandle());
        equal.addActionListener(new eventhandle());
        Minus.addActionListener(new eventhandle());
        Multiply.addActionListener(new eventhandle());
        divide.addActionListener(new eventhandle());
